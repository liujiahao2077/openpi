...
def make_mshab_example() -> dict:
    ...
    return {
        "observation/state": np.random.rand(30),
...
class MshabOutputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # For Mshab, we only return the first 13 actions (since the rest is padding).
        # For your own dataset, replace `13` with the action dimension of your dataset.
