...
class FetchRGBDObservationWrapper(gym.ObservationWrapper):
    ...
    def observation(self, observation):
        ...
        fetch_head_depth = observation["sensor_data"]["fetch_head"]["depth"]
        fetch_hand_depth = observation["sensor_data"]["fetch_hand"]["depth"]
        fetch_head_rgb = observation["sensor_data"]["fetch_head"]["rgb"]
        fetch_hand_rgb = observation["sensor_data"]["fetch_hand"]["rgb"]
